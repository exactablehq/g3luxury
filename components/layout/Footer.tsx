        ...
        <div className="grid w-full max-w-3xl gap-10 text-left sm:grid-cols-2">
          <div className="flex flex-col gap-3">
            <a
              ...
              className="flex items-center gap-3 font-sans text-sm text-(--color-text-muted) transition-colors hover:text-(--color-gold)"
            >
            ...
            <div className="flex gap-3">
              ...
              <div className="font-sans text-sm text-(--color-text-muted)">
