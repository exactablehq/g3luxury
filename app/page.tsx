...
export default function Home() {
  ...
  const [leaf1Transform, setLeaf1Transform] = useState("translateY(0px) rotate(0deg)");
  const [leaf2Transform, setLeaf2Transform] = useState("translateY(0px) rotate(0deg)");
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      setLeaf1Transform(`translateY(${scrollTop * 0.25}px) rotate(${scrollTop * 0.05}deg)`);
      setLeaf2Transform(`translateY(${scrollTop * -0.2}px) rotate(${scrollTop * -0.03}deg)`);
  ...
  return (
    <>
      ...
      <header id="hero" className="hero-section">
        ...
        <div className="floating-leaf leaf-1" style={{ transform: leaf1Transform }}>
          <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="rgba(212,175,55,0.15)" strokeWidth="1.5">
            <path d="M12 2C7.03 2 3 6.03 3 11c0 3.25 1.73 6.1 4.31 7.7L12 22l4.69-3.3C19.27 17.1 21 14.25 21 11c0-4.97-4.03-9-9-9zM12 18V2" strokeLinecap="round" />
          </svg>
        </div>
        <div className="floating-leaf leaf-2" style={{ transform: leaf2Transform }}>
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="rgba(143,151,121,0.2)" strokeWidth="1.5">
            <path d="M12 2C7.03 2 3 6.03 3 11c0 3.25 1.73 6.1 4.31 7.7L12 22l4.69-3.3C19.27 17.1 21 14.25 21 11c0-4.97-4.03-9-9-9zM12 18V2" strokeLinecap="round" />
          </svg>
        </div>
